    ...
    <table class="recipes-table">
        <tbody>
            <tr>
                ...
                // If we connected ok, let's run a query and output the responses
                $result = $conn->query("SELECT recipes.title, accounts.username, recipes.submitted_date, recipes.recipe_id FROM recipes LEFT JOIN accounts ON recipes.user_id=accounts.user_id");
